public class Departamento implements Reservas{
    ...
    public void reservar(String fecha) {
        if(!reservado){
            reservado = true;
            System.out.println("El Departamento encontrado en " + direccion + " esta reservado para " + fecha );
        } else {
    ...
    public void cancelarReserva() {
        if(reservado){
            reservado = false;
            System.out.println("La reserva del departamento en " + direccion + " fue cancelada");
        } else {
